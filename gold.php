...
<div class="row" style="padding-left: 40px">
  <div class="col-md-3">
      <div class="food-box">
        <div class="pic">
          <img src="https://staticimg.titan.co.in/Tanishq/Catalog/500629FJAAA00_1.jpg?impolicy=pqmed&imwidth=640" class="food-img">
        </div>
  ...
  <div class="col-md-3">
      <div class="food-box">
        ...
        <h2 class="food-title">Yellow Gold Carved Pendant</h2>
  ...
  <div class="col-md-3">
      <div class="food-box">
        <div class="pic"><img src="https://staticimg.titan.co.in/Tanishq/Catalog/511250PHXAAA00_1.jpg?impolicy=pqmed&imwidth=640" class="food-img"></div>
        <h2 class="food-title">Marvellous Beaded Mangalsutra</h2>
  ...
  <div class="col-md-3">
      <div class="food-box">
        ...
        <h2 class="food-title">Yellow Gold Woven Ring</h2>
...
<!-- NEW ROW -->
  ...
  <div class="col-md-3">
      <div class="food-box">
        <div class="pic">
          <img src="https://cspl-images.s3.amazonaws.com/images/cspljewels/20nam" class="food-img">
        </div>
  ...
  <div class="col-md-3">
      <div class="food-box">
        <div class="pic"><img src="https://cspl-images.s3.amazonaws.com/images/cspljewels/cms8835577cms8835587m" class="food-img"></div>
...
<!-- <div class="row" style="padding-left: 50px">  
  <div class="col-md-3">
<div class="cards">
  <img src="gold3.webp" width="100%" height="300px" alt="...">
  <div class="card-body">
    <h5 >Chic Eclectic Gold Ring</h5>
    <p class="card-text"> ₹ 12 404.00 </p>
   <a href="#" class="active" style="margin-left: 90px;padding: 3px ">Buy now</a>
  </div>
</div>
</div>
<div class="col-md-3">
<div class="cards">
  <img src="gold4.webp" class="card-img-top" height="300px" alt="...">
  <div class="card-body">
    <h5 >Yellow Gold Carved Pendant</h5>
    <p class="card-text">
 ₹ 16 419.00 </p>
   <a href="#" class="active" style="margin-left: 90px;padding: 3px ">Buy now</a>
  </div>
...
<div class="col-md-3">
<div class="cards">
  <img src="gold6.webp" class="card-img-top" height="300px" alt="...">
  <div class="card-body">
    <h5 >Marvellous Beaded Mangalsutra</h5>
    <p class="card-text">₹40 430.00</p>
    <a href="#" class="active" style="margin-left: 90px;padding: 3px ">Buy now</a>
  </div>
</div>
</div>
<div class="col-md-3">
<div class="cards">
  <img src="gold2.webp" class="card-img-top" height="300px" alt="...">
  <div class="card-body">
    <h5 >Yellow Gold Woven Ring</h5>
    <p class="card-text">₹
16 240.00</p>
    <a href="#" class="active" style="margin-left: 90px;padding: 3px ">Buy now</a>
  </div>
